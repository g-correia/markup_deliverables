---
title: "My Reproducible Manuscript [@boulesteix]"
...
## Simulation Study by @boulesteix
...
# Packages
packages <- c("mice", "Hmisc", "tidyverse")
...
```{r}
ggsave(filename = "../results/Figure.tif", plot = last_plot(), device = "tiff")
```
